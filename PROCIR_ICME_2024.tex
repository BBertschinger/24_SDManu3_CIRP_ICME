...
It is therefore better if the workpiece holding robot moves to a fixed position before the primary robot starts moving.
...
In section~\ref{subsec:PathPlanning} the path has been determined under the premise of optimal repeatability. Hereon a trajectory is generated to of maximize the robot’s travel speed and thus the process time.
