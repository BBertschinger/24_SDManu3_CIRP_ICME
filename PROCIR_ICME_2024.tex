...
\prop{This offline calibration is usually performed at certain points, hence it does not generalize in the entire workspace.
	The resulting model is not suited for industrial robot application, but provides a first enhanced kinematic model.
	 From a kinematic point of view incorporating the apriori manufacturing tolerances into the forward kinematic model yields an error measure in the task space. Such errors are usually much larger than the accuracy of the presented measurement system.}
%
