...
\begin{equation}
	\sigma_j = \sum_{j=1}^{3} \left( e_{i,j} + e_{i,j} + e_{i,j}\right)
\end{equation}
...
\begin{equation}
	\mathbf{\bar{M}}_{j} = \frac{\sum_{n=1}^{n_{sub}} \left( M_{n,j} \cdot \sigma_{n,j}^{-2} \right)}{\sum_{n=1}^{n_{sub}} \sigma_{n,j}^{-2}}
\end{equation}

The resulting error corresponds to:

\begin{equation}
	\mathbf{\bar{\sigma}}_{j} = \sqrt{ \frac{1}{\sum_{n=1}^{n_{sub}} \cdot \sigma_{n,j}^{-2}} }
\end{equation}
